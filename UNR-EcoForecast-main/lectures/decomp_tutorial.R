...
NDVI = read.csv(here("UNR-EcoForecast-main", "data", "portal_timeseries.csv"))
head(NDVI)
...
# both of them are picking up a big summer peak in greenness and a smaller winter peak
